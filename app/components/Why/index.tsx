...
const whydata: whydata[] = [
  {
    heading: "Experience in Technology",
    subheading:
      "Built by professionals experienced in AI automation & voice agent technology.",
  },
  {
    heading: " Service Focus",
    subheading:
      "100% focused on AI voice and workflow automation for growing businesses.",
  },
  {
    heading: "Cost-Effective",
    subheading:
      "Scale faster with AI: fewer agents, lower cost, smarter communication.",
  },
];
